...
const translations = {
    en: {
        ...
        titleAbout: "About Me",
        aboutText: "Computer Engineering student with hands-on experience in developing corporate and e-commerce websites. Skilled in WordPress, HTML, CSS, JavaScript and familiar with PHP. Passionate about Front-End Development, UI Design and modern web technologies.",
        titleSkills: "Skills",
    ...
    fa: {
        ...
        aboutText: "دانشجوی مهندسی کامپیوتر با تجربه عملی در طراحی و توسعه وب‌سایت‌های شرکتی و فروشگاهی. مسلط به وردپرس، HTML، CSS، جاوااسکریپت و آشنا به زبان PHP. علاقه‌مند به توسعه فرانت‌اَند، طراحی رابط کاربری و فناوری‌های مدرن وب",
